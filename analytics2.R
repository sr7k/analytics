...
omni1$sales
residuals(fit2)#Predict SalesQty for new combination of Values----

summary(residuals(fit2))#create a dataframe of new sample values
summary(fit2)
